...
Outside help may be accepted through issues, documentation, review, or pull requests, but no one is being handed trust by default.

If you want to help, bring useful work, clear evidence, and patience.

## Purpose

The goal is not to rewrite the past. The goal is to rebuild in a way that makes the same failures harder to repeat.
